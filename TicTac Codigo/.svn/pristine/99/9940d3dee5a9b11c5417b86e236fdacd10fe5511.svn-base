...
/**
 * Clase de la capa presentación que permite la implementación de la ventana para calcular la nomina de un departamento
 */
public class JFrameCalcularNominaDepartamento extends JFrame{
	...
	public JFrameCalcularNominaDepartamento(){
		...
		this.setTitle("Calcular nómina trabajador");
