...
/**
 * Clase de la capa presentación que permite la implementación de la ventana para asignar una competencia y trabajador
 */
public class JFrameAsignarCompetenciaTrabajador extends JFrame{
	...
	public JFrameAsignarCompetenciaTrabajador() {
		Dimension pantalla = Toolkit.getDefaultToolkit().getScreenSize();
				
		this.setTitle("Asignar competencia y trabajador");
		...
		enviar.addActionListener(new ActionListenerAsignarCompetenciaTrabajador());
	...
	public class ActionListenerAsignarCompetenciaTrabajador implements ActionListener{
		@Override
		public void actionPerformed(ActionEvent arg0){
			if(trabajador.getText().isEmpty() || competencia.getText().isEmpty()){
				...
				Controlador.getInstance().accion(ListaComandos.NEGOCIO_ASIGNAR_COMPETENCIA_TRABAJADOR, new TransferCompetenciaTrabajador(Integer.parseInt(trabajador.getText()), Integer.parseInt(competencia.getText()) ,true));	
			}
		}
	}
