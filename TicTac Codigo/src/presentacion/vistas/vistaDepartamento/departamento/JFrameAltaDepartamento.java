...
/**
 * Clase de la capa presentación que permite la implementación de la ventana de alta de un departamento
 */
public class JFrameAltaDepartamento extends JFrame{
	...
	public JFrameAltaDepartamento() {
		...
		enviar.addActionListener(new ActionListenerAltaDepartamento());
	...
	public class ActionListenerAltaDepartamento implements ActionListener{
		@Override
		public void actionPerformed(ActionEvent arg0){
			if(nombre.getText().isEmpty() || descripcion.getText().isEmpty()){
				...
				Controlador.getInstance().accion(ListaComandos.NEGOCIO_ALTA_DEPARTAMENTO, new TransferDepartamento(nombre.getText(), descripcion.getText(), true));	
			}
		}
	}
