...
/**
 * Clase de la capa presentación que permite la implementación de la ventana de baja de un departamento
 */
public class JFrameBajaDepartamento extends JFrame{
	...
	public JFrameBajaDepartamento(){
		...
		enviar.addActionListener(new ActionListenerBajaDepartamento());
	...
	public class ActionListenerBajaDepartamento implements ActionListener{
		@Override
		public void actionPerformed(ActionEvent arg0){
			if(id.getText().isEmpty()){
				...
				try{
					Controlador.getInstance().accion(ListaComandos.NEGOCIO_BAJA_DEPARTAMENTO, Integer.parseInt(id.getText()));
				}
