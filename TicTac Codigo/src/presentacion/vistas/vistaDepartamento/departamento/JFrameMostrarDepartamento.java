...
/**
 * Clase de la capa presentación que permite la implementación de la ventana de mostrar departamento
 */
	...
	public class ActionListenerMostrarDepartamento implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0){			
			try{
				...
				JOptionPane.showMessageDialog(null, "El formato del ID del departamento no es correcto", "Información", JOptionPane.INFORMATION_MESSAGE);
			}
		}
	}
