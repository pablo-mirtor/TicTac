...
/**
 * Clase de la capa presentación que permite la implementación de la ventana de baja de un trabajador
 */
public class JFrameBajaTrabajador extends JFrame{
	private static final long serialVersionUID = 1L;
	private JTextField id;
	private JButton enviar;
	private JButton volver;
	
	public JFrameBajaTrabajador(){
		...
		enviar.addActionListener(new ActionListenerBajaTrabajador());
	...
	public class ActionListenerBajaTrabajador implements ActionListener{
		@Override
		public void actionPerformed(ActionEvent arg0){
			if(id.getText().isEmpty()){
				...
				try{
					Controlador.getInstance().accion(ListaComandos.NEGOCIO_BAJA_TRABAJADOR, Integer.parseInt(id.getText()));
				}
