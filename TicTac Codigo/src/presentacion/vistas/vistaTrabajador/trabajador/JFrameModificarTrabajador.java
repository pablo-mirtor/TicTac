...
public class JFrameModificarTrabajador extends JFrame{
	...
	public JFrameModificarTrabajador() {
		...
		enviar.addActionListener(new ActionListenerModificarTrabajador());
	...
	public class ActionListenerModificarTrabajador implements ActionListener{
		@Override
		public void actionPerformed(ActionEvent arg0) {
			try {
				TransferTrabajador t = null;
		        if (tipo.getSelectedIndex() == 0) 
		        	t = new TransferTrabajadorParcial(Integer.parseInt(id.getText()), nombre.getText(), dni.getText(), Double.parseDouble(sueldo.getText()), Integer.parseInt(idDepartamento.getText()),true, Integer.parseInt(horasSemanales.getText()));
		        else
		        	t = new TransferTrabajadorCompleto(Integer.parseInt(id.getText()), nombre.getText(), dni.getText(), Double.parseDouble(sueldo.getText()), Integer.parseInt(idDepartamento.getText()),true, Integer.parseInt(productividad.getText()));			
		        
		        Controlador.getInstance().accion(ListaComandos.NEGOCIO_MODIFICAR_TRABAJADOR, t);
			} 
